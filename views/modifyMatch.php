...
<form action="#" method="post">
        ...
        <div class="container text-center mx-auto p-2">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="number" class="form-control classMargin" name="score_equipe1" id="score_equipe1" value="<?= $score1 ?>">
                ...
                <div class="col">
                    ...
                    <input type="number" class="form-control classMargin" name="score_equipe2" id="score_equipe2" value="<?= $score2 ?>">
    ...
    <?php } else { ?>
        <p class="text-light fs-2 text-center text-uppercase mt-5">Le match a bien été modifié</p>
